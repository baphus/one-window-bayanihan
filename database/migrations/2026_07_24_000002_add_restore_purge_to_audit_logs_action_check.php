...
{
    private const ACTIONS_OLD = "'CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'LOGIN_FAILED', 'EXPORT', 'ARCHIVE', 'UNARCHIVE', 'PUBLISH'";

    private const ACTIONS_NEW = "'CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'LOGIN_FAILED', 'EXPORT', 'ARCHIVE', 'UNARCHIVE', 'PUBLISH', 'RESTORE', 'PURGE'";
