...
class AgencySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $agencies = [
            ...
            ['id' => Str::uuid(), 'short' => 'DMW', 'slug' => 'dmw', 'name' => 'Department of Migrant Workers', 'logo_url' => 'https://dmw.gov.ph/images/dmw_logo.png', 'location_query' => 'Department of Migrant Workers Regional Office VII, Cebu City, Central Visayas, Philippines'],
            ...
            ['id' => Str::uuid(), 'short' => 'TESDA', 'slug' => 'tesda', 'name' => 'Technical Education and Skills Development Authority', 'logo_url' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQm8B1p66Z7vHm5UGtzegHjnts2VStAt3Rb7A&s', 'location_query' => 'TESDA Regional Office VII, Cebu City, Central Visayas, Philippines'],
