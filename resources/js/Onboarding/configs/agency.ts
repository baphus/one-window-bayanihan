    ...
    pages: [
        {
            ...
            steps: [
                ...
                { element: '[data-tour="sidebar-nav"]', title: 'Everything Lives Here', description: 'Referred Cases, Overdue Referrals, Services, Survey Forms, Survey Responses, and Reports — the sidebar is your map of the workspace.', side: 'right' as const },
