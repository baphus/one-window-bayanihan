    ...
    pages: [
        {
            ...
            steps: [
                ...
                { element: '[data-tour="sidebar-nav"]', title: 'Everything Lives Here', description: 'Cases, Clients, Referrals, Overdue Referrals, Stakeholders, Reports, and Audit Logs — the sidebar is your map of the whole workspace.', side: 'right' as const },
