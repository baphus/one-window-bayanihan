...
export default function NotificationsIndex() {
  ...
  const perPage = notifData?.meta?.per_page ?? 20;
  const lastPage = notifData?.meta?.last_page ?? 1;
  const currentPage = notifData?.meta?.current_page ?? 1;
      ...
      <AppLayout title="Notifications">
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Stay updated on cases and referrals.</p>
          </div>
