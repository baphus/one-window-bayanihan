...
vi.mock('@inertiajs/react', async () => {
  ...
  const initialData = { client_type: 'OFW', category_ids: [], vulnerability_indicator: 'None', nok_vulnerability_indicator: 'None', summary: '', client: { first_name: 'Draft', last_name: 'Client', middle_name: '', suffix: '', date_of_birth: '1990-01-01', sex: 'Male', email: 'draft@example.test', contact_number: '09170000000' }, address: { region: 'Region VII', province: 'Cebu', city_municipality: 'Cebu City', barangay: 'Lahug', street: '' }, employment: { employer_name: '', position: '', country: '', last_country: '', last_position: '', start_date: '', end_date: '', date_of_arrival: '', is_present: false }, next_of_kin: [], selected_nok_index: '', consent: false, selected_client_id: '', is_draft: true, case_issue_id: '', confirm_duplicate_client: false };
  return {
