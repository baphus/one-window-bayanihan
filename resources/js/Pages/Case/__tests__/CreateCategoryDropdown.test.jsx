...
vi.mock('@inertiajs/react', async () => {
  ...
  const initialData = { client_type: 'OFW', category_ids: [], vulnerability_indicator: 'None', nok_vulnerability_indicator: 'None', summary: '', client: { first_name: 'Maria', last_name: 'Santos', middle_name: '', suffix: '', date_of_birth: '1990-01-01', sex: 'Female', email: 'maria@example.test', contact_number: '09171234567' }, address: { region: 'VII', province: 'Cebu', city_municipality: 'Cebu City', barangay: 'Lahug', street: '' }, employment: { employer_name: 'Example Co.', position: '', country: '', start_date: '2020-01-01', end_date: '2024-01-01', last_country: 'Japan', last_position: 'Caregiver', date_of_arrival: '2024-02-01', is_present: false }, next_of_kin: [], selected_nok_index: '', consent: false, selected_client_id: '', is_draft: false, case_issue_id: '', confirm_duplicate_client: false };
  return {
