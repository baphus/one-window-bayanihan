      ...
      <form onSubmit={submit} className="space-y-6 max-w-3xl">
        <Section title="Password Policy" description="Define password complexity and expiration rules.">
          <div>
            ...
            {errors.password_min_length && <p className="mt-1 text-sm text-red-600">{errors.password_min_length}</p>}
          </div>
        ...
        <Section title="Session Security" description="Control session duration and account lockout behavior.">
          <div>
            ...
            {errors.session_lifetime_minutes && <p className="mt-1 text-sm text-red-600">{errors.session_lifetime_minutes}</p>}
          </div>
          ...
          <div>
            ...
            {errors.lockout_duration_minutes && <p className="mt-1 text-sm text-red-600">{errors.lockout_duration_minutes}</p>}
          </div>
        </Section>
        ...
        <Section title="Access Control" description="Restrict access with IP whitelisting and two-factor authentication.">
          ...
          <div>
            ...
            {errors.ip_whitelist_ips && <p className="mt-1 text-sm text-red-600">{errors.ip_whitelist_ips}</p>}
          </div>
