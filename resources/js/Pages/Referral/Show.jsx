                ...
                <div className="space-y-6">
                    <div className="rounded-lg bg-white shadow-sm border border-slate-200">
                        <div className="border-b border-slate-200 px-6 py-4">
                            <h3 className="text-lg font-semibold text-slate-900">Referral Information</h3>
                        </div>
                        <div className="px-6 py-4">
                            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <dt className="text-sm font-medium text-slate-500">Agency</dt>
                                    <dd className="mt-1 text-sm text-slate-900">{referral.agency?.name ?? 'N/A'}</dd>
                                </div>
                                <div className="sm:col-span-2">
                                    <dt className="text-sm font-medium text-slate-500">Required Services</dt>
                                    <dd className="mt-1 text-sm text-slate-900">{referral.required_services}</dd>
                                </div>
                                {referral.notes && (
                                    <div className="sm:col-span-2">
                                        <dt className="text-sm font-medium text-slate-500">Notes</dt>
                                        <dd className="mt-1 text-sm text-slate-900">{referral.notes}</dd>
                                    </div>
                                )}
                                {referral.decision && (
                                    <div className="sm:col-span-2">
                                        <dt className="text-sm font-medium text-slate-500">Decision / Resolution</dt>
                                        <dd className="mt-1 text-sm text-slate-900">{referral.decision}</dd>
                                    </div>
                                )}
                                <div>
                                        ...
                                        <li key={ms.id} className="border-l-2 border-indigo-200 pl-4">
                                            <div className="flex items-start justify-between">
                                                <div>
                                                    ...
                                                    {ms.description && (
                                                        <p className="mt-1 text-sm text-slate-500">{ms.description}</p>
                                                    )}
                                                </div>
