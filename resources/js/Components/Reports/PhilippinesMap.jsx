...
const SHAPES = {
  ...
  'negros-oriental': 'M136 78 C147 72 161 75 168 85 C174 95 176 110 173 124 C169 144 162 163 152 178 C145 190 133 195 123 189 C114 182 111 168 112 152 C113 134 117 115 124 101 C128 88 132 81 136 78 Z',
  siquijor: 'M237 224 C239 216 248 213 255 217 C261 221 264 230 261 238 C258 246 249 249 242 246 C236 242 234 232 237 224 Z',
};

const PROVINCE_LABELS = {
  cebu: { x: 198, y: 220, align: 'middle' },
  bohol: { x: 286, y: 126, align: 'middle' },
  'negros-oriental': { x: 136, y: 205, align: 'middle' },
  siquijor: { x: 226, y: 212, align: 'start' },
};
...
const PROVINCE_NOTCHES = {
  ...
  'negros-oriental': 'M161 96 C164 102 166 108 166 115',
  siquijor: 'M240 219 C244 218 247 219 250 222',
};
