...
const SHAPES = {
  'negros-oriental': 'M126 47 C137 39 152 40 164 48 C173 55 180 66 183 80 C185 95 184 111 181 125 C178 141 173 157 165 172 C158 184 148 193 138 197 C129 191 121 183 116 171 C111 159 108 145 107 130 C106 111 108 94 111 79 C114 66 118 53 126 47 Z',
  ...
  siquijor: 'M214 180 C218 176 224 176 228 180 C231 185 231 189 228 193 C224 196 219 196 215 193 C212 189 212 184 214 180 Z',
};

const PROVINCE_LABELS = {
  'negros-oriental': { x: 62, y: 118, align: 'start' },
  cebu: { x: 198, y: 220, align: 'middle' },
  bohol: { x: 286, y: 126, align: 'middle' },
  siquijor: { x: 214, y: 170, align: 'middle' },
};

const PROVINCE_NOTCHES = {
  'negros-oriental': 'M134 64 C140 62 147 63 152 67 C157 71 160 77 161 83',
  cebu: 'M204 58 C208 56 213 57 217 60 C220 63 223 68 224 74',
  bohol: 'M271 161 C277 159 284 159 290 162 C295 165 299 170 300 175',
  siquijor: 'M218 182 C221 181 224 181 226 183',
};
