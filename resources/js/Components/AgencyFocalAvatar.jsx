 ...
 * AgencyFocalAvatar
 *
 * 3-level fallback: user avatar → agency logo → person icon
 *
 * @param {object|null} user - { name, avatar_url?, agency?: { logo_url? } }
 * @param {'sm'|'md'|'lg'} size
 */
export default function AgencyFocalAvatar({ user, size = 'md' }) {
