        ...
        <div className="flex items-center gap-1 px-3">
          {start > 1 && (
            <>
              <button
                onClick={() => onPageChange?.(1)}
                className="w-[30px] h-[30px] flex items-center justify-center rounded-[2px] hover:bg-[#f1f5f9] text-slate-700 text-[13px] font-bold transition"
              >
                1
              </button>
          ...
          {pages.map((p) => (
            <button
              ...
              className={`w-[30px] h-[30px] flex items-center justify-center rounded-[2px] text-[13px] font-bold shadow-sm transition ${p === currentPage ? "bg-[#0b5384] text-white" : "hover:bg-[#f1f5f9] text-slate-700"}`}
            >
              {p}
            </button>
          ))}
