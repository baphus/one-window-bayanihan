<x-mail::message>
<h1 style="font-size: 20px; font-weight: 800; color: #18181b; margin: 0 0 16px 0; line-height: 1.3;">Referral Status Updated</h1>

<p style="font-size: 15px; line-height: 1.6; color: #52525b; margin: 0 0 12px 0;">A referral assigned to your agency has been updated.</p>
...
<strong style="color: #18181b;">Status:</strong> {{ $oldStatus }} → <strong style="color: #18181b;">{{ $newStatus }}</strong>
</td>
</tr>
</table>
...
<p style="font-size: 15px; line-height: 1.6; color: #52525b; margin: 0 0 4px 0;">Please review the updated referral details.</p>
